...
export default function PasswordForm() {
  ...
  return (
    <div className="border-t border-stone-200 pt-8 mt-8">
      <h2 className="text-lg font-bold text-stone-900 mb-1">Password</h2>
        ...
        {hasPassword && (
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-2 border border-stone-300 rounded text-stone-900 focus:outline-none focus:ring-2 focus:ring-stone-900 focus:border-transparent text-sm"
            />
          </div>
        )}
