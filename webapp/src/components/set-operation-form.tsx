  ...
  return (
    <div className="space-y-8">
      ...
      <button
        ...
        className="px-4 py-2 text-sm bg-accent text-text-inverted rounded hover:bg-accent-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
                  ...
                  <div className="space-y-3">
                    <div className="flex gap-2 items-center">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 text-sm bg-accent text-text-inverted rounded hover:bg-accent-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {saving ? "Saving..." : "Save"}
                      </button>
                    </div>
