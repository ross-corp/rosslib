      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-2 items-start">
          <input
            ...
            className="px-3 py-2 text-sm border border-stone-200 rounded bg-white text-stone-900 focus:outline-none focus:ring-2 focus:ring-stone-900 w-64"
          />
          <button
            onClick={loadTheirShelves}
            disabled={!theirUsername.trim() || loadingShelves}
            className="px-3 py-2 text-sm bg-stone-200 text-stone-700 rounded hover:bg-stone-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        {shelvesLoaded && theirShelves.length > 0 && (
          <div>
            ...
            <select
              ...
              className="w-full max-w-md px-3 py-2 text-sm border border-stone-200 rounded bg-white text-stone-900 focus:outline-none focus:ring-2 focus:ring-stone-900"
            >
