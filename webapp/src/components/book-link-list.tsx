          ...
          <div ref={dropdownRef} className="relative">
            ...
            {selectedBook ? (
              <div className="flex items-center gap-2 border border-border rounded px-3 py-2">
                ...
                >
                  <svg aria-hidden="true" viewBox="0 0 12 12" className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth={1.5}>
                      ...
                      <div className="shrink-0 flex items-center gap-1">
                        {isLoggedIn && (
                          <button
                            ...
                            aria-label={link.user_voted ? "Remove upvote" : "Upvote"}
                          >
                            <svg
                              aria-hidden="true"
                              viewBox="0 0 12 12"
                        ...
                        {isLoggedIn && (currentUsername === link.username || isModerator) && (
                          <button
                            ...
                            aria-label={currentUsername === link.username ? "Delete your link" : "Remove link (moderator)"}
                          >
                            <svg aria-hidden="true" viewBox="0 0 12 12" className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth={1.5}>
