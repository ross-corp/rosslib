...
- [ ] Search
  ...
  - [x] Results ranked by relevance, with popular books surfaced higher — default sort blends search-engine position with OL popularity signals (read count, rating quality, edition count); local results enriched with OL data during deduplication.
- [ ] Book pages
