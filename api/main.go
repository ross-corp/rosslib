...
func main() {
	...
	app.OnServe().BindFunc(func(se *core.ServeEvent) error {
		...
		se.Router.GET("/books/trending", handlers.GetTrendingBooks(app))
		...
		se.Router.GET("/users/{username}/followed-authors", handlers.GetUserFollowedAuthors(app)).BindFunc(handlers.OptionalAuthFunc(app))
